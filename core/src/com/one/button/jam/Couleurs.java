...
public class Couleurs {
	...
	int couleur;
	private Color couleurBalle, couleurFond, couleurSol, couleurLeger, couleurExit, couleurEau;
	...
	public Couleurs(int couleur){
		...
		if(couleur == 1){
			...
			couleurLeger = new Color().set(170/256f, 75/256f, 57/256f, 1);
			...
			couleurLeger = new Color().set(114/256f, 107/256f, 135/256f, 1);
			couleurExit = new Color().set(0, 0, 0, 0);
			...
			couleurLeger = new Color().set(139/256f, 170/256f, 166/256f, 1);
			couleurExit = new Color().set(0, 0, 0, 0);
			couleurEau = new Color().set(214/256f, 251/256f, 255/256f, 0.5f);
		}
		//Pico-8
			...
			couleurLeger = new Color().set(131/256f, 118/256f, 156/256f, 1);
