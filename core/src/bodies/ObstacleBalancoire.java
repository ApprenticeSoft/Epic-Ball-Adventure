...
public class ObstacleBalancoire extends Obstacle{
	...
	private float attacheY = 5 * Variables.PPT * Variables.WORLD_TO_BOX;

	public ObstacleBalancoire(World world, Camera camera, MapObject rectangleObject, Couleurs couleurs) {
		...
		if(rectangleObject.getProperties().get("AttacheY") != null){
			attacheY = Float.parseFloat(rectangleObject.getProperties().get("AttacheY").toString()) * Variables.PPT * Variables.WORLD_TO_BOX;
		}
	...
	public void draw(SpriteBatch batch, TextureAtlas textureAtlas){
		...
		batch.draw(textureAtlas.findRegion("WhiteSquare"),
					(ropeJointGauche.getAnchorB().x + ropeJointGauche.getAnchorA().x - epaisseurCorde)/2,
		...
		batch.draw(textureAtlas.findRegion("WhiteSquare"),
				(ropeJointDroite.getAnchorB().x + ropeJointDroite.getAnchorA().x - epaisseurCorde)/2,
	...
	public void drawOmbre(SpriteBatch batch, TextureAtlas textureAtlas){
		...
		//Dessin de la corde gauche
		batch.draw(textureAtlas.findRegion("WhiteSquare"),
					(ropeJointGauche.getAnchorB().x + ropeJointGauche.getAnchorA().x - epaisseurCorde)/2 + Variables.ombresX,
		...
		//Dessin de la corde droite
		batch.draw(textureAtlas.findRegion("WhiteSquare"),
				(ropeJointDroite.getAnchorB().x + ropeJointDroite.getAnchorA().x - epaisseurCorde)/2 + Variables.ombresX,
